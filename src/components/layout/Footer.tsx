    ...
    <footer className="bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-1">
            <Link href={`/${locale}`} className="inline-flex items-center gap-3 mb-6">
              <div className="w-12 h-12 border border-amber-400/50 rounded-full flex items-center justify-center">
                <span className="text-amber-400 font-serif text-2xl font-bold">F</span>
              </div>
              <div>
                <h2 className="text-white font-light text-lg tracking-widest uppercase">Families Tours</h2>
                <p className="text-amber-400/80 text-[10px] tracking-[0.3em] uppercase">familiestours.com</p>
              </div>
            </Link>
          ...
          {/* Experiences Column */}
          <div>
            <h3 className="text-xs tracking-[0.2em] uppercase text-amber-400 mb-8">{t.footer.experiences}</h3>
            <ul className="space-y-4">
              {[
                ...
                return (
                  <li key={idx}>
                    <Link href={`/${locale}/tours`} className="group flex justify-between items-center text-white/60 hover:text-white transition-colors duration-300">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs tracking-[0.2em] uppercase text-amber-400 mb-8">{t.footer.navigation}</h3>
            <ul className="space-y-4">
              {[
          ...
          {/* Contact Column */}
          <div>
            <h3 className="text-xs tracking-[0.2em] uppercase text-amber-400 mb-8">{t.footer.contact}</h3>
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="mailto:info@familiestours.com" className="text-white/60 hover:text-white text-sm transition-colors">
                  info@familiestours.com
                </a>
              </li>
              <li className="flex items-center gap-4">
                <Clock className="w-5 h-5 text-amber-400/60 flex-shrink-0" />
                <span className="text-white/60 text-sm">{t.footer.available247}</span>
              </li>
            </ul>
          </div>
        </div>
