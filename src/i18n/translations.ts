...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    about: {
      ...
      storySubtitle: '',
      storyP1: 'In 2009, Hassan El-Fassi stood at the edge of the Agafay plateau with nothing but his family\'s camel, a deep love for his homeland, and an audacious dream: to share the profound beauty of the Moroccan desert with families from around the world.',
  ...
  fr: {
    ...
    about: {
      ...
      storySubtitle: '',
      storyP1: 'En 2009, Hassan El-Fassi se tenait au bord du plateau d\'Agafay avec seulement le chameau de sa famille, un amour profond pour sa terre natale, et un rêve audacieux : partager la beauté profonde du désert marocain avec des familles du monde entier.',
  ...
  es: {
    ...
    about: {
      ...
      storySubtitle: '',
      storyP1: 'En 2009, Hassan El-Fassi estaba al borde de la meseta de Agafay con solo el camello de su familia, un amor profundo por su tierra natal, y un sueño audaz: compartir la profunda belleza del desierto marroquí con familias de todo el mundo.',
